...
public class StartingProject {
    static void main(String[] args) {
        ...
        //Every person has automatically an employee role
        ...
        //person1 is the manager,admin and employee
        //Simulating that we have accounts
        ...
        //There should be a user authentication
        // so i can assign a role and based on that to do the verification if person can see employers
        Scanner scanner = new Scanner(System.in);

        if (person1.hasRole("manager")){
            ...
            System.out.println("You have no access to employers");
        }
    }
